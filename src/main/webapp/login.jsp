...
<html>
	...
	<body>
		<header>
			<h2>
				<a href='./'>life4fun</a> <sub>會員登入</sub> 
			</h2>
		</header>
		<nav>
		...
		<article>			
			...
			<div class='errorMsg'><%= errorsList!=null?errorsList:"" %></div>			
				<p>
					<label for='phone_number'>帳號:</label>
					<input type='text' id='phone_number' name='phone_number' placeholder="請輸入phoneNumber或email" required>
