				...
				<div class="container relative">
					...
					<div class="top-bar d-none d-lg-flex">
						...
						<div class="top-bar__right">
							...
							<a href="login.html" class="top-bar__item top-bar__sign-in"
								...
								href="${webApplicationPath}/MemberServlet?method=member"
								id="SignIn_A">會員中心</a></a>
					...
					<div class="flex-parent">
						...
						<a href="${webApplicationPath}/CartServlet?method=showCart"
							...
							class="nav__mobile-cart-amount"></span>
						</a>
					</div>
					<!-- end flex-parent -->
				</div>
...
$(document).ready(function() {
	...
	<c:forEach var="street" items="${streetNameList}">
		streetName.set(['${street.postalCode}',
				'${street.city}', '${street.district}',
				'${street.road}' ]);
		cityList.add('${street.city}');
	</c:forEach>
