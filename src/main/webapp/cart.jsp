    ...
    <section class="section-wrap cart pt-50 pb-40">
      <div class="container relative">
          ...
          <table class="shop_table cart table">
            ...
            <tbody>
              ...
              <tr class="cart_item">
                <td class="product-thumbnail">
                  <a href="#">
                    <img src="static/picture/product_10.jpg" alt="">
                  </a>
                </td>
                <td class="product-name">
        ...
        <div class="row mb-30">
          ...
          <div class="col-lg-7">
            <div class="actions">
              <input type="submit" name="update_cart" value="Update Cart" class="btn btn-md btn-dark btn-button">
